        ...
        body: Column(
          children: [
            ...
            Container( //header ni boss
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("Bikin Akun, Langsung Sewa!", style: GoogleFonts.poppins(textStyle: TextStyle(
                    fontSize: 16
                  )),)
                ],
              ),
            ...
            Container(
              ...
              child: TextField(
              decoration: InputDecoration(
              label: Text("Input your confirm Password", style: GoogleFonts.poppins(textStyle: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: Color(0XFFC8C8C8)))),
              prefixIcon: Padding(
              padding: EdgeInsets.all(10.0),
              child: SvgPicture.asset(
                    'assets/images/lock.svg',
